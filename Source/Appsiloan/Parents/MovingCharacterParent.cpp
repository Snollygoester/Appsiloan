...
#include "MovingCharacterParent.h"
...
void AMovingCharacterParent::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AMovingCharacterParent::Tick(float DeltaTime)
{
...
void AMovingCharacterParent::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AMovingCharacterParent::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AMovingCharacterParent::LookUpAtRate);


}
void AMovingCharacterParent::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AMovingCharacterParent::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AMovingCharacterParent::MoveForward(float Value)
{
...
void AMovingCharacterParent::MoveRight(float Value)
{
	if ((Controller != NULL) && (Value != 0.0f))
	{
